    ...
    <?php foreach( $judicators as $judicator ): 
        ...
        ?>
            ...
            <a href="<?php echo esc_url( $permalink ); ?>"><div class="panel"><div class="listing-image"><?php $image = wp_get_attachment_image_src(
                                                ...
                                                <img src="<?php echo isset( $image[0] ) ? esc_url( $image[0] ) : ''; ?>" alt="<?php the_post_thumbnail_caption(); ?>"></div><div class="listing-text my-auto"><h4><?php echo esc_html( $title ); ?></h4></div></div></a>
    <?php endforeach; ?>
                                            </div>
<?php endif; ?>
<hr></hr>
