...
function msrseminars_render_ecosystem_band() {
	...
	?>
	<section class="seminars-ecosystem msr-reveal" aria-labelledby="seminars-ecosystem-heading">
		<div class="container">
			<header class="seminars-ecosystem__header text-center mb-4">
				<h2 id="seminars-ecosystem-heading" class="h4 seminars-ecosystem__title mb-2">
					<?php echo esc_html( msrseminars_get_ecosystem_band_title() ); ?>
				</h2>
				<p class="seminars-ecosystem__lead mb-0">
			...
			<div class="row g-3 justify-content-center">
				<?php foreach ( $links as $link ) : ?>
					<div class="col-md-4">
						<div class="seminars-ecosystem__card h-100">
							<h3 class="h6 seminars-ecosystem__card-title mb-2"><?php echo esc_html( $link['label'] ); ?></h3>
							<p class="small seminars-ecosystem__card-copy mb-3"><?php echo esc_html( $link['description'] ); ?></p>
